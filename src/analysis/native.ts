 ...
 * order.
 */
export function runComplexityAnalysis(syntax: SyntaxInventory): NativeAnalysisRun<ComplexityAnalysis> {
...
const CYCLE_METRICS = ["import-cycle.density", "import-cycle.groups", "import-cycle.modules"] as const;
