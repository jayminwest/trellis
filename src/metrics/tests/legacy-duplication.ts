/** Frozen quadratic reference for bounded regression tests only; never imported by an audit. */
/**
...
import { finalizeGroups, type RawGroup, type RawMember } from "./legacy-duplication-groups.ts";
