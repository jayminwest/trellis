...
- Search the codebase for related code (`Grep`/`Glob` for keywords, function names, file paths, criterion ids mentioned)
- Check for related Seeds work (`sd list`, `sd show <id>`) and related open PRs: `gh pr list --state open --search "<issue-title-keywords>"`
...
- **Alignment:** How well it fits trellis's direction
